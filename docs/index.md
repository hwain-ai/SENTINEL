...
| [docs/contributing.md](contributing.md) | 오류 제보, 문서·코드 수정과 PR 제출 방법 | 직접 관리하는 안내 문서 |
| [docs/development.md](development.md) | 개발 준비, 테스트 실행, 문서 검사와 실패 해결 방법 | `.githooks/**`, `.github/workflows/**`, `docs/manifest.json`, `scripts/docs_lint.py`, `scripts/verify_native.py`, `scripts/verify_repository.sh`, `tests/test_docs_lint.py` |
