...
| [plugins/sentinel/skills/fix/SKILL.md](../plugins/sentinel/skills/fix/SKILL.md) | 기본 호출과 같은 기준 통과까지 수정·재검사 | 직접 관리하는 안내 문서 |
...
| [plugins/sentinel/skills/upgrade-tools/SKILL.md](../plugins/sentinel/skills/upgrade-tools/SKILL.md) | 제작 저장소의 원본 도구 버전·잠금·어댑터·승인 갱신 | 직접 관리하는 안내 문서 |
